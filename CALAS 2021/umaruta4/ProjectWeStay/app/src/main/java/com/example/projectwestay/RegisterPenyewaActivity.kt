...
import com.example.projectwestay.databinding.ActivityRegisterPenyewaBinding
...
class RegisterPenyewaActivity : AppCompatActivity() {
    private lateinit var binding : ActivityRegisterPenyewaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRegisterPenyewaBinding.inflate(layoutInflater)
    ...
    fun initializeListener(){
        binding.buttonDaftar.setOnClickListener(object: View.OnClickListener{
            override fun onClick(view: View?){
                ...
                var call: Call<Response<StatusResponse>> = service.registerPenyewa(namaLengkap, email, noKtp,username, password)
